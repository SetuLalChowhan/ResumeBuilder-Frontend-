      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="flex gap-2">
            ...
            <Link to={`/app`}
            className=" hidden md:block px-8 py-2 bg-purple-600 hover:bg-purple-700 active:scale-95 transition-all rounded-full text-white"
            hidden={!user}
            >
            Dashboard
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 2xl:size-132 bg-purple-400 blur-[100px] opacity-30"></div>
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
            ...
            <span className=" bg-gradient-to-r from-purple-700 to-indigo-600 bg-clip-text text-transparent text-nowrap">
              AI-powered{" "}
            </span>{" "}
            Resume
          </h1>
          ...
          <p className="max-w-md text-center text-base my-7">
            Create,edit and download professinal resumes with AI-powered
            assistance.
          </p>
          ...
          <div className="flex items-center gap-4 ">
            <Link
              to={`/app`}
              className="bg-purple-600 hover:bg-purple-700 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-purple-400 flex items-center transition-colors"
            >
              Get started
              <svg
                xmlns="http://www.w3.org/2000/svg"
